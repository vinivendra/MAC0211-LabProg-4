...
/*
 ...
 O método v_rotateA também é um pouco mais pesado, pois vai chamar uma vez a
 'cosf' e uma vez a 'sinf'. Já o v_rotateSC recebe essas informações, então é mais eficiente.
 Os outros métodos (sejam initializers, setters ou getters) são muito mais leves.
